...
🛠️ 실습 세션: 2.5시간 (31.25%) - Lab 1 + Lab 2
👥 학생 케어: 3시간 (37.5%) - 개별 지원
```
...
| **12:00-13:00** | 🛠️ 실습 1 | [Dockerfile 빌드 실습](./lab_1.md) | 커스텀 이미지 제작 |
| **13:00-14:00** | 🍽️ 점심 | 점심시간 (60분) | |
| **14:00-15:00** | 🛠️ 실습 1 | [Dockerfile 빌드 실습 계속](./lab_1.md) | 커스텀 이미지 제작 |
| **15:00-15:15** | ☕ 휴식 | 15분 휴식 | |
| **15:15-16:05** | 🛠️ 실습 2 | [Docker 레지스트리 & 배포](./lab_2.md) | 이미지 공유 |
| **16:05-18:00** | 👥 케어 | 개별 멘토링 & 회고 | 맞춤 지원 |
...
### [Lab 1: Dockerfile & 이미지 빌드 실습](./lab_1.md)
**시간**: 12:00-13:00 + 14:00-15:00 (120분)

#### 🎯 핵심 내용
- **커스텀 이미지 제작**: 기본 Dockerfile 작성부터 고급 최적화까지
- **멀티스테이지 빌드**: 빌드와 런타임 환경 분리
- **이미지 최적화**: 크기 축소와 보안 강화
- **실전 애플리케이션**: Node.js, Python Flask 애플리케이션 Docker화

#### 🔑 핵심 키워드
- Dockerfile, Multi-stage Build, Image Optimization
- Security Best Practices, .dockerignore, Health Check

### [Lab 2: Docker 레지스트리와 배포 실습](./lab_2.md)
**시간**: 15:15-16:05 (50분)

#### 🎯 핵심 내용
- **Docker Hub 활용**: 내가 만든 이미지 업로드 및 공유
- **이미지 태깅**: 버전 관리와 태깅 전략
- **레지스트리 배포**: push/pull 명령어 실습
- **팀 협업**: 다른 사람의 이미지 사용 및 피드백

#### 🔑 핵심 키워드
- Docker Registry, Docker Hub, Image Tag
- Push/Pull, Image Repository, Semantic Versioning
...
**시작**: [Session 1 - Docker 이미지 구조](./session_1.md)
