...
🛠️ 실습 세션: 2시간 (25%) - Dockerfile 빌드 실습
👥 학생 케어: 3.5시간 (43.75%) - 개별 지원 강화
```
...
| **13:00-15:00** | 🛠️ 실습 4 | [Dockerfile 빌드 실습](./session_4.md) | 커스텀 이미지 제작 |
| **15:00-15:15** | ☕ 휴식 | 15분 휴식 | |
| **15:15-18:00** | 👥 케어 | 개별 멘토링 & 회고 | 맞춤 지원 |
...
### [Session 4: Dockerfile & 이미지 빌드 실습](./session_4.md)
**시간**: 13:00-15:00 (120분)
