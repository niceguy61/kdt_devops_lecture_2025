...
- **Database 팀**: MySQL/PostgreSQL 컨테이너 구성
- **DevOps 팀**: Docker Compose 통합 및 배포

### 📋 프로젝트 요구사항
1. **웹 애플리케이션**: 간단한 CRUD 기능
2. **데이터베이스**: 컨테이너로 구성된 DB
3. **환경 분리**: 개발/스테이징/프로덕션 환경
4. **자동화**: Docker Compose로 원클릭 배포
5. **모니터링**: 기본 로그 수집
...
- [ ] Docker 기본 명령어로 컨테이너 관리 가능
- [ ] Dockerfile 작성하여 커스텀 이미지 빌드 가능
...
### 🤔 회고 질문
1. DevOps 문화가 기존 개발 방식과 어떻게 다른지 체감했나요?
2. 컨테이너 기술의 장점을 실제로 경험해보셨나요?
3. 팀 프로젝트에서 가장 인상 깊었던 협업 경험은?
4. 각자의 강점이 어떻게 팀에 기여했나요?

### 📈 개선 포인트
- Docker 명령어 사용 시 자주 발생한 실수
- 팀 협업에서 소통의 어려움
- 개념 이해와 실습 적용 간의 격차
- 개인별 학습 속도 차이 조정

### 🎉 성취 사항
- DevOps 문화에 대한 깊은 이해 획득
- 컨테이너 기술의 실무 활용 능력 개발
- 다양한 배경의 동료들과 성공적인 협업
- 각자의 강점 발견 및 자신감 향상
